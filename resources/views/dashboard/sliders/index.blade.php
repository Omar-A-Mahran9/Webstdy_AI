    ...
    <div class="card mb-5 mb-x-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
            ...
            <div class="card-title m-0">
                <h3 class="fw-bold m-0">{{ __('Sliders list') }}</h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
            ...
            <div class="d-flex flex-stack flex-wrap mb-5">
                ...
                <div class="d-flex align-items-center position-relative my-1 mb-2 mb-md-0">
                    ...
                    <input type="text" data-kt-docs-table-filter="search"
                        class="form-control form-control-solid w-250px ps-15" placeholder="{{ __('Search for sliders') }}">
                </div>
                <!--end::Search-->
                <!--begin::Toolbar-->
                <!--begin::Add customer-->
                <a class="d-flex justify-content-end btn btn-primary" href="{{ route('dashboard.sliders.create') }}"
                    data-kt-initialized="1" data-kt-docs-table-toolbar="base">
            ...
            <table id="kt_datatable" class="table align-middle text-center table-row-dashed fs-6 gy-5">
                <thead>
                    <tr class=" text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                        ...
                        <th style="text-align: center">{{ __('Button name') }}</th>
...
@push('scripts')
    ...
    <script src="{{ asset('assets/dashboard/js/datatables/sliders.js') }}"></script>
