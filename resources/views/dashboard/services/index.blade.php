...
@section('content')
    <div class="card mb-5 mb-x-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
            ...
            <div class="d-flex justify-content-center flex-wrap gap-3 mb-5 mt-5">
                ...
                <!--begin::Toolbar-->
                <div>
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#crud_modal"
                        data-bs-toggle="tooltip" data-bs-original-title="{{ __('Coming Soon') }}">
            ...
            <div class="d-flex flex-stack flex-wrap mb-5">
                ...
                <div class="d-flex align-items-center position-relative my-1 mb-2 mb-md-0">
                    ...
                    <input type="text" data-kt-docs-table-filter="search"
                        class="form-control form-control-solid w-250px ps-15" placeholder="{{ __('Search for Service') }}">
                </div>
                <!--end::Search-->
    ...
    <form id="crud_form" class="ajax-form w-50" action="{{ route('dashboard.services.store') }}" method="post"
...
@push('scripts')
    ...
    <script src="{{ asset('assets/dashboard/js/datatables/services.js') }}"></script>
    ...
    <script>
        $(document).ready(function() {
            $("#add_btn").click(function(e) {
                ...
                $("#crud_form").attr('action', "{{ route('dashboard.services.store') }}");
