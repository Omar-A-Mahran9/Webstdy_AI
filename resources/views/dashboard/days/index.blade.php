...
@section('content')
            ...
            <div class="card border-hover-primary h-100">
                ...
                <div class="card-header border-0 pt-9">
                    ...
                    <div class="card-title m-0">
                        ...
                        <h4 class="fw-bold me-auto px-4 py-3">{{ __('Days') }}</h4>
                ...
                <div class="card-body p-9">
                    ...
                    <div class="d-flex  justify-content-between flex-wrap ">
                        ...
                        <div class=" rounded min-w-125px py-1 px-4 me-7">
                            <div class="fs-2 fw-bold">{{ __('Days count') }}</div>
                            <div class="fs-4  ">{{ $count_days }}</div>
                        </div>
                        <!--end::Due-->
    ...
    <div class="card mb-5 mb-x-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
            ...
            <!--begin::Card title-->
            <div class="card-title m-0">
                <h3 class="fw-bold m-0">{{ __('Days List') }}</h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
            ...
            <div class="d-flex flex-stack flex-wrap mb-5">
                ...
                <div class="d-flex align-items-center position-relative my-1 mb-2 mb-md-0">
                    ...
                    <input type="text" data-kt-docs-table-filter="search"
                        class="form-control form-control-solid w-250px ps-15" placeholder="{{ __('Search for day') }}">
                </div>
                <!--end::Search-->
    ...
    <form id="crud_form" class="ajax-form" action="{{ route('dashboard.days.store') }}" method="post"
            ...
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="form_title">{{ __('Add new day') }}</h5>
                        <!--begin::Close-->
                    ...
                    <div class="modal-body">
                        ...
                        <div class="fv-row mb-0 fv-plugins-icon-container">
                            <label for="date_inp"
                                class="form-label required fs-6 fw-bold mb-3">{{ __('Select Date') }}</label>
                            <input type="date" name="date" class="form-control form-control-lg form-control-solid"
                                id="date_inp" placeholder="{{ __('Select Date') }}">
                            <div class="fv-plugins-message-container invalid-feedback" id="date"></div>
                        </div>

                        <!-- Fields to show the selected day in Arabic and English -->
                        <div class="fv-row mb-4 fv-plugins-icon-container">
                            <label for="day_ar_inp"
                            ...
                            <input type="text" name="name_ar" class="form-control form-control-lg form-control-solid"
                                id="day_ar_inp" placeholder="{{ __('Day in Arabic') }}" readonly>
                        </div>
                        <div class="fv-row mb-4 fv-plugins-icon-container">
                            <label for="day_en_inp"
                            ...
                            <input type="text" name="name_en" class="form-control form-control-lg form-control-solid"
                                id="day_en_inp" placeholder="{{ __('Day in English') }}" readonly>
                        </div>
                    </div>
...
@push('scripts')
    ...
    <script src="{{ asset('assets/dashboard/js/datatables/days.js') }}"></script>
    ...
    <script>
        $(document).ready(function() {
            $("#add_btn").click(function(e) {
                ...
                $("#form_title").text(__('Add new day'));
                $("[name='_method']").remove();
                $("#crud_form").trigger('reset');
                $("#crud_form").attr('action', `/dashboard/days`);
    ...
    <script>
        // Function to get the day name in Arabic and English
        function getDayNames(date) {
            ...
            return {
                day_en: daysOfWeek.en[dayOfWeek],
                day_ar: daysOfWeek.ar[dayOfWeek]
            };
        }

        // Event listener for the date input field
        document.getElementById('date_inp').addEventListener('change', function() {
            const selectedDate = this.value;

            // Get the day names in Arabic and English
            const {
                day_en,
                day_ar
            } = getDayNames(selectedDate);

            // Set the values in the respective fields
            document.getElementById('day_en_inp').value = day_en;
            document.getElementById('day_ar_inp').value = day_ar;
        });
    </script>
@endpush
