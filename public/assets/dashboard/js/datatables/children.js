                    ...
                    render: function (data, type, row) {
                        return `
                            <div>
                                <!--begin::Info-->
                                <div class="d-flex flex-column justify-content-center">
                                    <a href="javascript:;" class="mb-1 text-gray-800 text-hover-primary">${row.birthdate}</a>
                                </div>
                                <!--end::Info-->
                            </div>
                        `;
    ...
    var handleEditRows = () => {
        ...
        editButtons.forEach((d) => {
            ...
            d.addEventListener("click", function (e) {
                ...
                $("#birthdate_inp").val(data.birthdate);
